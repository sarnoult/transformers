...
class DataTrainingArguments:
    ...
    test_files: Optional[list] = field(
        default=None,
        metadata={"help": "An optional list of input test data files to predict on (a csv or JSON file)."},
    )
...
def main():
    ...
    if data_args.dataset_name is not None:
        ...
        if data_args.test_files is not None:
            for i, test_file in enumerate(data_args.test_files):
                data_files["test{}".format(i)] = test_file
    ...
    # Predict
    def predict(test_id):
        test_dataset = tokenized_datasets[test_id]
        ...
        output_test_results_file = os.path.join(training_args.output_dir, "{}_results.txt".format(test_id))
        ...
        # Save predictions
        output_test_predictions_file = os.path.join(training_args.output_dir, "{}_predictions.txt".format(test_id))
        if trainer.is_world_master():
    ...
    if training_args.do_predict:
        logger.info("*** Predict ***")
        for i in range(len(data_args.test_files)):
            predict("test{}".format(i))
